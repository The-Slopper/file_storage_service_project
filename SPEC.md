# Especificacao Tecnica — File Storage Service

| Campo | Valor |
|---|---|
| Repositorio | `file_storage_service_project` |
| Linguagem | Go (Go modules) |
| Versao | 1.0 |
| Status | Ativo |

## 1. Objetivo e escopo

Aplicacao de RAG: ingestao de documentos, busca vetorial e respostas com contexto. Este documento descreve requisitos, arquitetura e criterios de aceite.
...
Segue o scaffold idiomatico de Go: codigo-fonte, testes e manifesto de build
...
- [ ] `go mod tidy` conclui sem erros.
- [ ] `go run ./...` executa o componente.
- [ ] `go test ./...` passa (CI verde, cobertura 100%).
